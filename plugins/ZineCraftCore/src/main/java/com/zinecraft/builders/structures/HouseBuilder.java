...
public class HouseBuilder extends AbstractStructureBuilder {
    ...
    private void buildWalls(EditSession session, int x, int y, int z, BlockType material) {
        // Murs extérieurs
    ...
    private void buildRoof(EditSession session, int x, int y, int z, BlockType roofMaterial) {
