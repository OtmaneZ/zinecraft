...
public class WeaponCommand implements CommandExecutor {
    ...
    private void listWeapons(Player player) {
        ...
        player.sendMessage(ChatColor.GRAY + "  /weapon give canard " + ChatColor.WHITE + "- 🦆 Canard Glacial");
        player.sendMessage(ChatColor.GRAY + "  /weapon give vole " + ChatColor.WHITE + "- 🪶 Vole Vole");
        player.sendMessage("");
    ...
    private void giveWeapon(Player player, String weaponName) {
        ...
        switch (weaponName.toLowerCase()) {
            ...
            case "duck":
            case "icyduck":
                type = WeaponType.ICY_DUCK;
                break;
            case "vole":
            case "volevole":
            case "fly":
            case "flyfly":
                type = WeaponType.FLY_FLY;
                break;
            default:
